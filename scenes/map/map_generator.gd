...
#mexer nesses 2 aq se a distancia fica esquisita
const X_DIST := 30
const Y_DIST := 25
const PLACEMENT_RANDOMNESS := 5 #tiver mt alinhado ou MUITO desalinhado esse aq
...
func generate_map() -> Array[Array]:
	map_data = _generate_initial_gird()
...
func _generate_initial_gird() -> Array[Array]:
